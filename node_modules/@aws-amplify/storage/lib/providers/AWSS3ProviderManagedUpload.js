...
var stream_collector_native_1 = require("@aws-sdk/stream-collector-native");
...
var AWSS3ProviderManagedUpload = /** @class */ (function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        if (!httpHandlerOptions_1.httpHandlerOptions.bufferBody) return [3 /*break*/, 3];
                        return [4 /*yield*/, stream_collector_native_1.streamCollector(body)];
    ...
    AWSS3ProviderManagedUpload.prototype._createNewS3Client = function (config, emitter) {
        ...
        var client = new client_s3_1.S3Client(__assign(__assign({ region: region,
            credentials: credentials }, localTestingConfig), { requestHandler: new axios_http_handler_1.AxiosHttpHandler(httpHandlerOptions_1.httpHandlerOptions, emitter), customUserAgent: core_1.getAmplifyUserAgent(), urlParser: url_parser_node_1.parseUrl }));
